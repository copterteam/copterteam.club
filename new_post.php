...
<title>Новая запись в блог пользователя | COPTERTEAM.club </title>
...
deleteImages($parray[usermail],$link);

?>

<div class="main_content">

<form action="new_post" method="post" id="add_post" class="poster" onsubmit="return false;">
...
<input type="text" name="post_header" placeholder="Основной заголовок записи" />
...
<label class="tags" for="post_tags">Добавить ключевые слова</label><br>
<input type="text" name="post_tags" id="tags" placeholder="Ключевые слова через запятую" />
</div>

<label for="post_body">Дата и время:</label>
<input type="text" name="date_time" id="date_time" value="<?echo(date('d.m.Y H:i',time()));?>" readonly /><br>


	<div class="clearfix"></div>

<button type="button" id="submit_form">Опубликовать</button>
...
<script src="/_js/upl/main.js"></script>

		<script src="_js/main.js"></script>
		<script src="_js/poster.js"></script>
