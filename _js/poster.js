...
$(document).ready(function(){
	   	...
	   	var postdata=
		 {
		 mailval:$('.main_content form#add_post').find('input[name="mail"]').val(),
 		 nickval:$('.main_content form#add_post').find('input[name="nickval"]').val(),
 		 idval:$('.main_content form#add_post').find('input[name="idval"]').val(),
		 images:'',
		 post_header:'',
		 post_body:'',
		 post_tags:'',
   ...
   function updateImages(){
	...
	$('.main_content  form.poster .thumbnails span.thumb_item').click(function(){
  ...
  $('.main_content  form#add_post input#date_time').datetimepicker({
	  timepicker:true,
      format:'d.m.Y H:i',
      lang:'ru',
	  maxDate:new Date(),
    ...
    $.datetimepicker.setLocale('ru');
	 ...
	 $('.main_content form#add_post button#submit_form').click(function(evt){                // Сохранение записи
		...
		if( $(this).parent('form').find('input[name="post_header"]').val() != '' ){
		 ...
		 postdata.post_body = $(this).parent('form').find('textarea[name="post_body"]').val();
 		 postdata.post_tags = $(this).parent('form').find('input#tags').val();
		 ...
		 $.post('posterHandler.php',postdata,function(answer){ 
			  ...
			  if( answer == 'OK' ){
			        ...
			        window.location.href='/users/'+postdata.nickval;
	...
	$('.main_content form#add_post input[name="post_header"]').change(function(){ $(this).removeClass('error'); } );  
